...
cp -f $INSTALL_DIR/bruttrack.desktop /usr/share/applications/ 2> /dev/null
cp -f $INSTALL_DIR/bruttrack.desktop /usr/share/applications/bruttrack.desktop 2> /dev/null
cp -f $INSTALL_DIR/bruttrack.desktop /usr/share/kali-menu/applications/bruttrack.desktop 2> /dev/null
cp -f $INSTALL_DIR/bruttrack.png /usr/share/pixmaps/ 2> /dev/null
...
mkdir -p /usr/share/bruttrack/loot/workspaces/ 2> /dev/null
ln -fs /usr/share/bruttrack/loot/workspaces/ /home/kali/Desktop/workspaces 2> /dev/null
